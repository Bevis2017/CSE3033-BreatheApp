...
public class SummaryAty extends JFrame {
    ...
    public SummaryAty() {
        ...
        btnDaily.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new SummaryDaily("Summary Activity").setVisible(true);
            }
        });
        ...
        btnWeekly.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new SummaryWeekly("Summary Activity").setVisible(true);
            }
        });
        ...
        btnMonthly.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new SummaryMonthly("Summary Activity").setVisible(true);
            }
        });
    }
}
